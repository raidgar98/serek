...
\begin{document}
	...
	% blank page
	{
		...
		{
			\begin{flushright}
				\it Mamie i przyjaciołom, którzy pomogli w ciężkich chwilach.
			\end{flushright}
		}
	...
	% thanks
	{
		...
		\begin{center}
			...
			Chciałbym podziękować \citeauthor{scihub}, założycielce projektu \nonpl{Sci-Hub} \cite{scihub}, portalu, który zapewnia
