	...
	return result;
...

		{
...

			{
				...
				Opisane wady i zalety można zaobserwować na przykładzie przedstawionym na rysunku numer \ref{half_automatic_example}. Wspomniany
...

	{
...

		{
...

			{
				...
				jest zdecydowanie największa. Cała zajmuje obszar w pliku \nonpl{benchmarks/controllers/benchmark_controllers.cpp} pomiędzy $26$ a~$141$ wierszem,
...
// ...
				...
				pół automatyczna zewnętrzna refleksja pól wszystkich klas modelu (\code{FC_REFLECT} oraz \code{FC_REFLECT_DERIVED}). Same metody
