	...
	% browse of current solutions
	{
...

		{
...

			{
				...
				lub dodanie pola, wymagana jest ingerencja w~kod w~obu funkcjach (patrz rysunek \ref{manual_reflection_example}).\n
...

	{
...

		{
...

			{
				...
				implementacji serializacji. Objętość koniecznego kodu, aby dorównać funkcjonalnością pozostałym bibliotekom, jest zdecydowanie
				największa. Cała zajmuje obszar w pliku \nonpl{benchmarks/controllers/benchmark_controllers.cpp} pomiędzy $26$ a~$141$ wierszem, dając sumarycznie $115$ linii kodu.\n
