...
\begin{document}
	...
	% theory
	{
		...
		Tłumacząc na polski (tłumaczenie własne):
		...
		\end{quotation}
			...
			Warto też wspomnieć, że modyfikacja innego programu, może również odnosić się do modyfikowania
			samego siebie, co jest powszechną praktyką stosowaną w językach programowania, za pomocą
			dyrektyw pre-procesora w języku C, szablonów w języku C++ czy makr w języku LISP.


			\newpage
			Jak zostało wspomniane we wstępie, biblioteka standardowa języka C++ w 2023 roku, nie posiada
		modułu odpowiedzialnego za serializację i deserializacje danych do formatu JSON.
